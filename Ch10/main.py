...
biKmeans_func(dat_other_1, 10, "kmean_res_cent_file_1.txt", "kmean_res_clus_file_1.txt")
biKmeans_func(dat_other_2, 10, "kmean_res_cent_file_2.txt", "kmean_res_clus_file_2.txt")
biKmeans_func(dat_other_3, 10, "kmean_res_cent_file_3.txt", "kmean_res_clus_file_3.txt")
biKmeans_func(dat_other_4, 10, "kmean_res_cent_file_4.txt", "kmean_res_clus_file_4.txt")
biKmeans_func(dat_other_5, 10, "kmean_res_cent_file_5.txt", "kmean_res_clus_file_5.txt")
biKmeans_func(dat_other_6, 10, "kmean_res_cent_file_6.txt", "kmean_res_clus_file_6.txt")
